...
#define QUBEX_CONTRACT_INDEX 11
...
<<<<<<< HEAD
    {"QUBEX", 144, 10000, sizeof(QUBEX)},
=======
    {"QUBEX", 146, 10000, sizeof(QUBEX)},
>>>>>>> feature/QS-4-qubex-qubic-sc-development
    // new contracts should be added above this line
#ifdef INCLUDE_CONTRACT_TEST_EXAMPLES
...
static void initializeContracts()
{
    ...
    REGISTER_CONTRACT_FUNCTIONS_AND_PROCEDURES(QUBEX);
    // new contracts should be added above this line
#ifdef INCLUDE_CONTRACT_TEST_EXAMPLES
